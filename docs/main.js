...
// }
// ];
var tsk1Btn = document.querySelector('#l30-tsk1-btn');
...
function runl30Tsk1() {
  ...
  document.write('<main style="display: flex; justify-content:center; align-items: center; flex-wrap: wrap; height: 100%; font-family: arial; font-size: 1.2rem;"></main>');
...
var tsk2Btn = document.querySelector('#l30-tsk2-btn');
...
function runl30Tsk2() {
  ...
  var openBtnText = document.createTextNode('OPEN');
  openBtn.append(openBtnText);
  openBtn.setAttribute('style', 'outline: none; width: 250px; height: 150px; border: none; border-radius: 40px; cursor: pointer; font-size: 3rem; background-color: hsl(154, 4%, 32%); color: white;');
  main.append(openBtn);
  openBtn.addEventListener('click', function () {
    ...
    closeBtn.setAttribute('style', 'outline: none; width: 250px; height: 150px; border: none; border-radius: 40px; cursor: pointer; font-size: 3rem');
    modal.append(closeBtn);
    modal.setAttribute('style', 'display: flex; justify-content:center; align-items: center; height: 100%; width: 100%; background-color: hsl(154, 4%, 32%);');
    main.append(modal);
    openBtn.hidden = true;
...
var tsk3Btn = document.querySelector('#l30-tsk3-btn');
tsk3Btn.addEventListener('click', runl30Tsk3);

function runl30Tsk3() {
  document.write('<main style="display: flex; justify-content:center; align-items: center; flex-direction: column; height: 100%; font-family: arial; font-size: 1.2rem; background-color: hsl(154, 4%, 32%);"></main>');
  var body = document.querySelector('body');
  body.setAttribute('style', 'margin: 0;');
  var main = document.querySelector('main');
  ...
  lightsContainer.setAttribute('style', 'width: 150px; height: 300px; background-color: white; border-radius: 20px; margin: 50px; display: flex;flex-direction: column; align-items: center; justify-content: center;');
  lightsContainer.append(redLight);
  redLight.setAttribute('style', 'width: 75px; height: 75px; border: 5px solid hsl(154, 4%, 32%); border-radius: 100%; background-color: black; transition: background 500ms;');
  lightsContainer.append(yellowLight);
  yellowLight.setAttribute('style', 'width: 75px; height: 75px; border: 5px solid hsl(154, 4%, 32%); border-radius: 100%; background-color: black; transition: background 500ms;');
  lightsContainer.append(greenLight);
  greenLight.setAttribute('style', 'width: 75px; height: 75px; border: 5px solid hsl(154, 4%, 32%); border-radius: 100%; background-color: black; transition: background 500ms;');
  main.append(btn);
  btn.setAttribute('style', 'width: 75px; height: 75px; border: none; border-radius: 100%; background-color: white; font-size: 1.5rem; font-weight: bold; cursor: pointer; color: hsl(154, 4%, 32%)');
...
var tsk1Btn = document.querySelector('#l31-tsk1-btn');
tsk1Btn.addEventListener('click', runl31Tsk1, {
  once: true
});

function runl31Tsk1() {
  var container = document.querySelector('.main__l31-container');
  var div = document.createElement('div');
  var text = document.createTextNode('Lorem ipsum dolor, sit amet consectetur adipisicing elit. Velit dolorem voluptatibus nobis fugit vitae delectus molestias eaque temporibus non id impedit eum quo autem sequi, neque quae unde! Obcaecati, beatae.');
  container.append(div);
  div.append(text);
  div.classList.add('content');
  div.setAttribute('style', 'margin: 20px auto; width: 500px; font-size: 1.5rem; color: hsl(44, 100%, 69%);');
  document.body.addEventListener('keydown', function (event) {
    if ((event.code === 'KeyE' || event.code === 'Comma') && event.ctrlKey) {
      ...
      if (event.code === 'KeyE' && element.nodeName === 'DIV') {
        ...
        _newElement.setAttribute('style', 'margin: 20px auto; width: 500px; font-size: 1.5rem; color:  hsl(9, 100%, 67%);');

        _newElement.className = 'content';
        _newElement.textContent = element.value;
        element.replaceWith(_newElement);
      }
    }
  });
} //TASK 2
...
var tsk2Btn = document.querySelector('#l31-tsk2-btn');
tsk2Btn.addEventListener('click', runl31Tsk2, {
  once: true
});
...
function runl31Tsk2() {
  ...
  var Employee = function Employee(name, position, department, remuneration) {
    _classCallCheck(this, Employee);
  ...
  var bankEmpArray = [new Employee('Ruslan Ku', 'Dev', 'Top', 1e6), new Employee('Igor Chief', 'Cool', 'Main', 1e5), new Employee('Igor Chef', 'Middle', 'Nah', 1e5), new Employee('Spongebob Squarepants', 'Yeap', 'Deep', 1e9), new Employee('Patrick Star', 'Rock', 'Deep', 1e8)];
...
var tsk3Btn = document.querySelector('#l31-tsk3-btn');
tsk3Btn.addEventListener('click', runl31Tsk3, {
  once: true
});
...
function runl31Tsk3() {
  ...
  div.setAttribute('style', 'margin: 20px auto; width: 500px; font-size: 1.5rem; color: hsl(44, 100%, 69%); border: 2px solid hsl(9, 100%, 67%)');
...
/* harmony import */ var _js_l30_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./js/l30.js */ "./js/l30.js");
/* harmony import */ var _js_l30_js__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_js_l30_js__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _js_l31_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./js/l31.js */ "./js/l31.js");
/* harmony import */ var _js_l31_js__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_js_l31_js__WEBPACK_IMPORTED_MODULE_8__);
